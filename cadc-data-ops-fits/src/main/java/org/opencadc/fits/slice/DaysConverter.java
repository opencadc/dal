...
public class DaysConverter {
    private static final Logger LOGGER = Logger.getLogger(DaysConverter.class);
    ...
    public final double from(final double value, final String unit) {
        ...
        if (unitList.contains(unit)) {
            final double days = value * MULTIPLIERS[unitList.indexOf(unit)];
            LOGGER.debug("Converting " + value + " from " + unit + " to " + days);
            return days;
        } else {
