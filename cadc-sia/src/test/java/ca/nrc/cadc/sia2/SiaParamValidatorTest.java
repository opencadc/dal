 ...
 * @author pdowler
 */
public class SiaParamValidatorTest {

    private static final Logger log = Logger.getLogger(SiaParamValidatorTest.class);
    ...
    public void testValidateFOV() {
        ...
        try {
            ...
            Method m = SiaParamValidator.class.getMethod("validateFOV", Map.class);
    ...
    public void testValidateSPATRES() {
        ...
        try {
            ...
            Method m = SiaParamValidator.class.getMethod("validateSPATRES", Map.class);
    ...
    public void testValidateEXPTIME() {
        ...
        try {
            ...
            Method m = SiaParamValidator.class.getMethod("validateEXPTIME", Map.class);
    ...
    public void testValidateCOLLECTION() {
        try {
            ...
            Method method = SiaParamValidator.class.getMethod("validateCOLLECTION", Map.class);
    ...
    public void testValidateFACILITY() {
        try {
            ...
            Method method = SiaParamValidator.class.getMethod("validateFACILITY", Map.class);
            doValidateString(method, testParams, null);
        } catch (Exception unexpected) {
            log.error("unexpected exception", unexpected);
            Assert.fail("unexpected exception: " + unexpected);
    ...
    public void testValidateINSTRUMENT() {
        try {
            ...
            Method method = SiaParamValidator.class.getMethod("validateINSTRUMENT", Map.class);
            doValidateString(method, testParams, null);
        } catch (Exception unexpected) {
            log.error("unexpected exception", unexpected);
            Assert.fail("unexpected exception: " + unexpected);
    ...
    public void testValidateDPTYPE() {
        try {
            ...
            Method method = SiaParamValidator.class.getMethod("validateDPTYPE", Map.class);
    ...
    public void testValidateCALIB() {
        try {
            ...
            Method m = SiaParamValidator.class.getMethod("validateCALIB", Map.class);
    ...
    public void testValidateTARGET() {
        try {
            ...
            Method method = SiaParamValidator.class.getMethod("validateTARGET", Map.class);
            doValidateString(method, testParams, null);
        } catch (Exception unexpected) {
            log.error("unexpected exception", unexpected);
            Assert.fail("unexpected exception: " + unexpected);
    ...
    public void testValidateTIMERES() {
        try {
            ...
            Method m = SiaParamValidator.class.getMethod("validateTIMERES", Map.class);
    ...
    public void testValidateSPECRP() {
        try {
            ...
            Method m = SiaParamValidator.class.getMethod("validateSPECRP", Map.class);
    ...
    public void testValidateFORMAT() {
        try {
            ...
            Method method = SiaParamValidator.class.getMethod("validateFORMAT", Map.class);
            doValidateString(method, testParams, null);
        } catch (Exception unexpected) {
            log.error("unexpected exception", unexpected);
            Assert.fail("unexpected exception: " + unexpected);
