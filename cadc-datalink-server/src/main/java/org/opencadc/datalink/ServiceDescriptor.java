...
public class ServiceDescriptor {
    ...
    /**
     * Service Descriptor ID for a forward reference. The DataLink service_def output
     * refers to a descriptor using this ID.
     */
    public String id;
    
    /**
     * Optional: IVOA standard identifier if the service implements an IVOA standard.
     */
