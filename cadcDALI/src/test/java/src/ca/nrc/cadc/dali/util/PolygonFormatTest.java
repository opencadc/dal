 ...
 * @author pdowler
 */
public class PolygonFormatTest 
{
    private static final Logger log = Logger.getLogger(PolygonFormatTest.class);

    public PolygonFormatTest() { }
    ...
    public void testInvalidStringRep() throws Exception
    {
        ...
        String tooShort = "10.0 10.0 12.0 10.0";
        String tooShortOdd = "10.0 10.0 12.0 10.0 11.0";
        String tooOdd = "10.0 10.0 12.0 10.0 11.0 11.0 8.0";
        
        try { format.parse(tooShort); }
        catch(IllegalArgumentException expected) { }
        
        try { format.parse(tooShortOdd); }
        catch(IllegalArgumentException expected) { }
        
        try { format.parse(tooOdd); }
        catch(IllegalArgumentException expected) { }
    }
    ...
    public void testNull() throws Exception
    {
        ...
        Polygon object = format.parse(null);
