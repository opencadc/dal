 ...
 * @author pdowler
 */
public class CircleFormatTest 
{
    private static final Logger log = Logger.getLogger(CircleFormatTest.class);

    public CircleFormatTest() { }
    ...
    public void testInvalidStringRep() throws Exception
    {
        ...
        String tooShort = "12.0 34.0";
        String tooLong = "12.0 34.0 2.0 3.0";
    ...
    public void testNull() throws Exception
    {
        ...
        Circle object = format.parse(null);
